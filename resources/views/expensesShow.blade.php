                ...
                <div class="p-10">
                    ...
                    <div class="mb-10 flex items-center justify-between">
                        ...
                        <a href="{{ route('expenses.index') }}"
                           class="group inline-flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-blue-600 transition-all duration-200 bg-white border border-slate-200 hover:border-blue-200 hover:bg-blue-50/50 px-4 py-2 rounded-xl shadow-sm">
                    ...
                    <!-- Expense Card -->
                    <div class="bg-white/90 backdrop-blur-sm border border-slate-200 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden">
                        ...
                        <div class="p-10">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                ...
                                <!-- Amount Card -->
                                <div class="relative bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-500 rounded-2xl p-8 overflow-hidden shadow-lg shadow-blue-200">
                                    <!-- Decorative circles -->
                                        ...
                                        <div class="mt-6 pt-6 border-t border-white/20">
                                            ...
                                            <div class="flex items-center gap-3 mt-2">
                                                <div class="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center text-white font-bold text-sm">
                                                    {{ strtoupper(substr(data_get($expense, 'user.name', '?'), 0, 1)) }}
                                                </div>
                                            ...
                                            <li class="group bg-white rounded-2xl border border-slate-100 p-4 hover:border-blue-100 hover:shadow-sm transition-all duration-200">
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-white font-bold text-sm shadow-md shadow-indigo-200 flex-shrink-0">
                                                            {{ strtoupper(substr(data_get($participant, 'name'), 0, 1)) }}
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        <div class="text-right">
                                                            ...
                                                            @if(!data_get($participant, 'is_payer'))
                                                                <span class="inline-block mt-1 px-2 py-0.5 rounded-full text-xs font-semibold
                                                                    {{ data_get($participant, 'pay') ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-600' }}">
                                                                    {{ data_get($participant, 'pay') ? 'Settled' : 'Owes' }}
                                                                </span>
                                                            @endif
                                                        </div>
                                                        ...
                                                        @if(!data_get($participant, 'is_payer') && !data_get($participant, 'pay'))
                                                            <form action="{{ route('settlement.pay') }}" method="POST">
                                                                ...
                                                                <button type="submit"
                                                                    class="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-semibold rounded-xl bg-emerald-500 text-white hover:bg-emerald-600 shadow-sm hover:shadow-md hover:shadow-emerald-200 transition-all duration-200 whitespace-nowrap">
